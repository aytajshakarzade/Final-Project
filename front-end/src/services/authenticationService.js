...
export const subscribeToAuth = (listener) => { listeners.add(listener); return () => listeners.delete(listener); };
...
export async function register(payload) {
  await authApi.register({ ...payload, confirmPassword: payload.confirmPassword || payload.password });
}
